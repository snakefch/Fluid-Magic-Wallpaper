package com.live.fluidwallpaper.magicapp.ui.component.language

import android.content.res.Configuration
import com.ads.control.ads.ITGAd
import com.facebook.shimmer.ShimmerFrameLayout
import com.live.fluidwallpaper.magicapp.R
import com.live.fluidwallpaper.magicapp.ads.AdsManager.nativeAdLanguage
...
import com.live.fluidwallpaper.magicapp.app.GlobalAppV3
import com.live.fluidwallpaper.magicapp.databinding.ActivityLanguageBinding
...
import com.live.fluidwallpaper.magicapp.ui.bases.ext.showToastById
...
class LanguageActivity : BaseActivity<ActivityLanguageBinding>(),
    ...
    override fun initViews() {
        ...
        com.live.fluidwallpaper.magicapp.ads.AdsManager.setPreLoadNativeCallback(this)
        showNativeLanguage()
    ...
    private fun setLanguageDefault() {
        ...
        if (GlobalAppV3.instance.getLanguage() != null && !listLanguages.contains(GlobalAppV3.instance.getLanguage())) {
            listLanguages.remove(listLanguages[listLanguages.size - 1])
            val modelLanguage = GlobalAppV3.instance.getLanguage()
            if (modelLanguage != null) {
                listLanguages.add(5, modelLanguage)
            }
        ...
        mBinding.rclLanguage.smoothScrollToPosition(5)
    }
