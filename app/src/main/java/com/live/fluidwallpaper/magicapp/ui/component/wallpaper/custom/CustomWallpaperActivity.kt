...
import com.live.fluidwallpaper.magicapp.databinding.ActivityCustomWallpaperBinding
...
class CustomWallpaperActivity : BaseActivity<ActivityCustomWallpaperBinding>() {
    ...
    private fun loadConfigPreset() {
        ...
        com.live.fluidwallpaper.magicapp.ui.component.wallpaper.fluids.SettingsStorage.loadConfigFromInternalPreset(presetName, assets, Config.Current)
