...
import com.live.fluidwallpaper.magicapp.app.AppConstants.KEY_IS_CUSTOM
import com.live.fluidwallpaper.magicapp.app.AppConstants.KEY_NAME_EFFECT
import com.live.fluidwallpaper.magicapp.databinding.ActivityWallpaperBinding
...
import com.live.fluidwallpaper.magicapp.ui.bases.ext.showToastByString
import com.live.fluidwallpaper.magicapp.ui.bases.ext.visibleView
import com.live.fluidwallpaper.magicapp.ui.component.dialog.DialogSetName
    ...
    override fun initViews() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            launch(Dispatchers.Main) {
                ...
                if (job.isCompleted) {
                    initAdsBanner()
                    com.live.fluidwallpaper.magicapp.ads.AdsManager.loadInterSetWallpaper(this@WallpaperActivity)
                }
            }
...
//        CommonAlerts.showShareImage(this, uri)
    ...
    private fun applyWallpaper() {
        if (com.live.fluidwallpaper.magicapp.ads.AdsManager.mInterstitialAdSetWallpaper != null && com.live.fluidwallpaper.magicapp.ads.AdsManager.mInterstitialAdSetWallpaper!!.isReady && com.live.fluidwallpaper.magicapp.ads.CheckTimeShowAdsInter.isTimeShow) {

            ITGAd.getInstance().forceShowInterstitial(
                this@WallpaperActivity,
                com.live.fluidwallpaper.magicapp.ads.AdsManager.mInterstitialAdSetWallpaper,
    ...
    private fun applySettingsToLwp(z: Boolean, i: Int) {
        if (z) {
            ...
            com.live.fluidwallpaper.magicapp.ui.component.wallpaper.fluids.SettingsStorage.loadConfigFromInternalPreset(
                presetModel?.name,
                assets,
                config
            )
    ...
    private fun loadConfigPreset() {
        if (intent.hasExtra(AppConstants.KEY_PRESET_MODEL)) {
            ...
            if (presetModel?.typePresetModel == TypePresetModel.CUSTOM) {
                com.live.fluidwallpaper.magicapp.ui.component.wallpaper.fluids.SettingsStorage.loadConfigPresetCustom(presetModel?.pathFluidCustom, config)
            } else
                com.live.fluidwallpaper.magicapp.ui.component.wallpaper.fluids.SettingsStorage.loadConfigFromInternalPreset(
                    presetModel?.name,
                    assets,
    ...
    private fun setLiveWallpaper() {
        try {
            val componentName = ComponentName(
                packageName, com.live.fluidwallpaper.magicapp.services.WallpaperService::class.java.name
            )
